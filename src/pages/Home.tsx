...
const Home = () => {
  ...
  return (
    <Layout>
      ...
      <div
        ref={containerRef}
        className="w-full relative overflow-hidden flex justify-center bg-transparent px-4 sm:px-6 lg:px-8"
      >
        <motion.div
        ...
        >
          ...
          <div className="w-full flex flex-col lg:flex-row items-center lg:items-start justify-between bg-transparent p-4 sm:p-6 lg:p-10 rounded-2xl border border-gray-800 shadow-xl will-change-transform will-change-opacity gap-8 lg:gap-12">
            {/* Hero Text Section */}
            <div className="w-56 sm:w-full flex flex-col justify-center lg:justify-start">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white font-bold flex flex-col gap-2 sm:gap-4 lg:gap-6 leading-tight">
                ...
                >
                  ...
                  <img
                    src={darklogo}
                    className="w-4 h-auto sm:w-7 md:w-8 lg:w-9 pt-1 sm:pt-2 md:pt-3 lg:pt-5 ml-1 mr-2"
                    loading="eager"
          ...
          {/* CTA Button Section */}
          <div
            className="w-full flex items-center justify-center pt-8 sm:pt-12 lg:pt-16 xl:pt-24 opacity-0 animate-fadeIn"
      ...
      <Suspense
        fallback={
          <div className="min-h-[100vh] w-full flex items-center justify-center bg-black">
