...
import { type Color, type Spacing } from '../../themes/types';
...
const StyledBox = styled.div<StyledBoxProps>`
  ...
  background-color: ${({ theme: { palette }, background = 'transparent' }: {theme: any, background?: any}) =>
    palette[background]};
  border-radius: ${({ theme, borderRadius }: {theme: any, borderRadius?: any}) =>
    borderRadius ?? theme.borderRadius};
  color: ${({ theme: { palette } }: {theme: any}) => palette.foreground};
  ${getBoxSizeStyles}
`;
